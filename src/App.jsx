...
const APIS = [
  ...
  { id: 'portfolio-agent', name: 'Portfolio Agent', url: 'https://portfolio-agent-backend-k6d6.onrender.com' },
  { id: 'Nexpair', name: 'Nexpair', url: 'https://sms-backend-yqkx.onrender.com' },
];
